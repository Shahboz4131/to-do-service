...
func Load() Config {
	...
	c.PostgresUser = cast.ToString(getOrReturnDefault("POSTGRES_USER", "shahboz"))
	c.PostgresPassword = cast.ToString(getOrReturnDefault("POSTGRES_PASSWORD", "shahboz4131"))
